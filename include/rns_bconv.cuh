...
__forceinline__ __device__ uint128_t base_convert_acc(const uint64_t *ptr, const uint64_t *QHatModp,
...
__forceinline__ __device__ uint128_t2 base_convert_acc_unroll2(const uint64_t *ptr, const uint64_t *QHatModp,
                                                               size_t out_prime_idx, size_t degree, size_t ibase_size,
                                                               size_t degree_idx) {
    uint128_t2 accum{0};
    for (int i = 0; i < ibase_size; i++) {
...
__forceinline__ __device__ uint128_t4 base_convert_acc_unroll4(const uint64_t *ptr, const uint64_t *QHatModp,
                                                               size_t out_prime_idx, size_t degree, size_t ibase_size,
                                                               size_t degree_idx) {
    uint128_t4 accum{0};
    for (int i = 0; i < ibase_size; i++) {
...
__forceinline__ __device__ double_t2 base_convert_acc_frac_unroll2(const uint64_t *ptr, const double *qiInv,
...
__forceinline__ __device__ double_t4 base_convert_acc_frac_unroll4(const uint64_t *ptr, const double *qiInv,
                                                                   size_t degree, size_t ibase_size,
                                                                   size_t degree_idx) {
    double_t4 accum{0};
    for (int i = 0; i < ibase_size; i++) {
